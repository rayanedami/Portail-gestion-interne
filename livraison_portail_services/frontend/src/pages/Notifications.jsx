                            ...
                            {filteredNotifications.map((notification) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <td><div className="notification-sender"><span className="sender-avatar">{notification.expediteur_photo ? <img src={notification.expediteur_photo} alt="" /> : <UserRound />}</span><div><strong>{notification.expediteur_nom || "Système"}</strong><small>{notification.expediteur_role || (notification.expediteur_nom ? "Utilisateur" : "Portail")}</small></div></div></td>
